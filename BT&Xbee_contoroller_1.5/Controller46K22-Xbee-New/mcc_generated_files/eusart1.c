...
void EUSART1_Initialize(void) {
    ...
    // Baud Rate = 58858; SPBRGL 15; 
    SPBRG1 = 0x8A;

    // Baud Rate = 58858; SPBRGH 1; 
    SPBRGH1 = 0x00;
...
void EUSART1_Write(uint8_t txData) {
    ...
    if (0 == PIE1bits.TX1IE && waitCTS == false) {
        TXREG1 = txData;
        //__delay_ms(1);
    } else {
        PIE1bits.TX1IE = 0;
...
void EUSART1_Buffer_in(uint8_t txData) {
    while (0 == eusart1TxBufferRemaining);
    PIE1bits.TX1IE = 0;
    eusart1TxBuffer[eusart1TxHead++] = txData;
    if (sizeof (eusart1TxBuffer) <= eusart1TxHead) {
