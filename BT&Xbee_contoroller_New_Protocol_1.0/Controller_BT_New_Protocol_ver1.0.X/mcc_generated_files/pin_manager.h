...
#define IO_TactSw11_TRIS               TRISC1
#define IO_TactSw11_LAT                LATC1
#define IO_TactSw11_PORT               PORTCbits.RC1
#define IO_TactSw11_SetHigh()    do { LATC1 = 1; } while(0)
#define IO_TactSw11_SetLow()   do { LATC1 = 0; } while(0)
#define IO_TactSw11_Toggle()   do { LATC1 = ~LATC1; } while(0)
#define IO_TactSw11_GetValue()         PORTCbits.RC1
#define IO_TactSw11_SetDigitalInput()    do { TRISC1 = 1; } while(0)
#define IO_TactSw11_SetDigitalOutput()   do { TRISC1 = 0; } while(0)

// get/set IO_TactSw12 aliases
#define IO_TactSw12_TRIS               TRISC2
#define IO_TactSw12_LAT                LATC2
#define IO_TactSw12_PORT               PORTCbits.RC2
#define IO_TactSw12_ANS                ANSC2
#define IO_TactSw12_SetHigh()    do { LATC2 = 1; } while(0)
#define IO_TactSw12_SetLow()   do { LATC2 = 0; } while(0)
#define IO_TactSw12_Toggle()   do { LATC2 = ~LATC2; } while(0)
#define IO_TactSw12_GetValue()         PORTCbits.RC2
#define IO_TactSw12_SetDigitalInput()    do { TRISC2 = 1; } while(0)
#define IO_TactSw12_SetDigitalOutput()   do { TRISC2 = 0; } while(0)

#define IO_TactSw12_SetAnalogMode()   do { ANSC2 = 1; } while(0)
#define IO_TactSw12_SetDigitalMode()   do { ANSC2 = 0; } while(0)
...
#define IO_TactSw02_TRIS               TRISC5
#define IO_TactSw02_LAT                LATC5
#define IO_TactSw02_PORT               PORTCbits.RC5
#define IO_TactSw02_ANS                ANSC5
#define IO_TactSw02_SetHigh()    do { LATC5 = 1; } while(0)
#define IO_TactSw02_SetLow()   do { LATC5 = 0; } while(0)
#define IO_TactSw02_Toggle()   do { LATC5 = ~LATC5; } while(0)
#define IO_TactSw02_GetValue()         PORTCbits.RC5
#define IO_TactSw02_SetDigitalInput()    do { TRISC5 = 1; } while(0)
#define IO_TactSw02_SetDigitalOutput()   do { TRISC5 = 0; } while(0)

#define IO_TactSw02_SetAnalogMode()   do { ANSC5 = 1; } while(0)
#define IO_TactSw02_SetDigitalMode()   do { ANSC5 = 0; } while(0)
// get/set TX1 aliases
...
#define IO_TactSw10_TRIS               TRISD2
#define IO_TactSw10_LAT                LATD2
#define IO_TactSw10_PORT               PORTDbits.RD2
#define IO_TactSw10_ANS                ANSD2
#define IO_TactSw10_SetHigh()    do { LATD2 = 1; } while(0)
#define IO_TactSw10_SetLow()   do { LATD2 = 0; } while(0)
#define IO_TactSw10_Toggle()   do { LATD2 = ~LATD2; } while(0)
#define IO_TactSw10_GetValue()         PORTDbits.RD2
#define IO_TactSw10_SetDigitalInput()    do { TRISD2 = 1; } while(0)
#define IO_TactSw10_SetDigitalOutput()   do { TRISD2 = 0; } while(0)

#define IO_TactSw10_SetAnalogMode()   do { ANSD2 = 1; } while(0)
#define IO_TactSw10_SetDigitalMode()   do { ANSD2 = 0; } while(0)
...
#define IO_TactSw01_TRIS               TRISD5
#define IO_TactSw01_LAT                LATD5
#define IO_TactSw01_PORT               PORTDbits.RD5
#define IO_TactSw01_ANS                ANSD5
#define IO_TactSw01_SetHigh()    do { LATD5 = 1; } while(0)
#define IO_TactSw01_SetLow()   do { LATD5 = 0; } while(0)
#define IO_TactSw01_Toggle()   do { LATD5 = ~LATD5; } while(0)
#define IO_TactSw01_GetValue()         PORTDbits.RD5
#define IO_TactSw01_SetDigitalInput()    do { TRISD5 = 1; } while(0)
#define IO_TactSw01_SetDigitalOutput()   do { TRISD5 = 0; } while(0)

#define IO_TactSw01_SetAnalogMode()   do { ANSD5 = 1; } while(0)
#define IO_TactSw01_SetDigitalMode()   do { ANSD5 = 0; } while(0)
// get/set TX2 aliases
