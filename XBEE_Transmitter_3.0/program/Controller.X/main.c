...
void main(void) {
    ...
    while (1) {
        if (tmrFlag) {
            ...
            EUSART_CompWrite((IO_RDown_GetValue() << 7) | (IO_LDown_GetValue() << 6) | ((1 - IO_RDipSw_GetValue()) << 1) | (IO_LDipSw_GetValue() << 0) | (IO_RAnPush_GetValue() << 3) | (IO_LAnPush_GetValue() << 2));
            EUSART_Write('E');
            EUSART_Write('E');
         ...
         * (12)右アナログ垂直方向[0]~[7]RV
         * (13)(12)のNOT
         * (14)右下[7],左下[6]　0[5]　0[4]　右モードSW[3]RMS　左モードSW[2]LMS　右アナログ押込[1]R3　左アナログ押込[0]L3　
         * (15)(14)のNOT
         * (16)'E'
         * (17)'E'
         *
